...
import com.livgo.tools.soso.utils.search.OschinaSearchUtil;
 ...
 */
@Controller
@RequestMapping("oschinasearch")
public class OschinaSearchController extends BaseController {
    ...
    public ResponseBean search(String str, int pnum) {
        try {
            ...
            pnum = pnum < 1 ? 1 : pnum;
            return ResponseBean.SUCCESS(OschinaSearchUtil.search(str, pnum));
        } catch (Exception e) {
